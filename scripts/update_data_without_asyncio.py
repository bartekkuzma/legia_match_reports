...
class DataManager:
    ...
    def __init__(self, credentials: Credentials, data_directory: PathLike):
    ...
    def fetch_match_data(self, match_id: int) -> None:
    ...
    def process_all_matches(self) -> None:
        ...
        self.logger.info("Starting download of match data...")
        for match_id in tqdm(to_download["match_id"], desc="Downloading matches"):
...
def main() -> None:
    ...
    manager = DataManager(credentials=credentials, data_directory=args.data_dir)
