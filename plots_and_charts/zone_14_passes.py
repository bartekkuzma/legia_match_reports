...
class Zone14Passes:
    ...
    def is_pass_zone_14(x: float, y: float) -> bool:
        if (
            x >= Constants.PITCH_DIMS["zone_14_x"]
            and x <= Constants.PITCH_DIMS["zone_14_x"] + Constants.PITCH_DIMS["zone_14_length"]
        ):
            if (
                y >= Constants.PITCH_DIMS["zone_14_y"]
                and y <= Constants.PITCH_DIMS["zone_14_y"] + Constants.PITCH_DIMS["zone_14_width"]
            ):
                return True
        return False
    ...
    def plot_passes_to_zone_14(
        self, team_for: bool, directory: str, figsize: tuple[int, int] = (16, 12)
    ) -> plt.Figure:
        ...
        ax.add_patch(
            plt.Rectangle(
                (Constants.PITCH_DIMS["zone_14_y"], Constants.PITCH_DIMS["zone_14_x"]),
                Constants.PITCH_DIMS["zone_14_width"],
                Constants.PITCH_DIMS["zone_14_length"],
                facecolor=Constants.COLORS["cyan"],
                alpha=0.3,
                zorder=1,
        ...
        pitch.arrows(
            xstart=complete["x"],
            ystart=complete["y"],
            xend=complete["pass_end_x"],
            yend=complete["pass_end_y"],
            width=2,
            headwidth=3,
            headlength=4,
        ...
        pitch.arrows(
            xstart=incomplete["x"],
            ystart=incomplete["y"],
            xend=incomplete["pass_end_x"],
            yend=incomplete["pass_end_y"],
            width=2,
            headwidth=3,
            headlength=4,
