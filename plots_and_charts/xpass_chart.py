...
class ExpectedPassChart:
    ...
    def plot_xpass_plot(self, directory: str, figsize: tuple[int, int] = (20, 20)):
        ...
        cbar.set_ticks(ticks=[-self.pass_diff + 1, 0, self.pass_diff - 1], labels=[-self.pass_diff, "0", self.pass_diff], fontsize=20)
