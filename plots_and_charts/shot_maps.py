...
class ShotMaps:
    ...
    def plot_shot_map(self, team_for: bool, directory: str, figsize: tuple[int, int] = (8, 12)) -> plt.Figure:
        ...
        ax1.text(
            x=0.65,
            y=0.75,
            s=f"{title}'s shots from the match.",
            fontsize=28,
            fontweight="bold",
        ...
        ax2.scatter(x=10, y=points_average_distance, s=100, color=Constants.COLORS["white"], linewidth=0.8)
        ...
        ax3.text(
            x=0.5, y=2.5, s="xG/Shot", fontsize=20, fontweight="bold", color=Constants.COLORS["white"], ha="center"
        )
    ...
    def plot_advanced_shot_map(self, team_for: bool, directory: str, figsize: tuple[int, int] = (8, 12)) -> plt.Figure:
        ...
        for x in shots.to_dict(orient="records"):
            ...
            edge_color = (
                edge_color if x["shot_outcome"] in ["Goal", "Saved", "Saved to Post"] else Constants.COLORS["sb_grey"]
            )
        ...
        # add another axis for the stats
        ax3 = fig.add_axes([1, 0.2, 0.2, 0.05])
        ax3.set_facecolor(Constants.DARK_BACKGROUND_COLOR)
        ax3.set_xlim(0, 1)
        ax3.set_ylim(0, 1)
        ...
        ax3.text(
            x=0.3, y=7, s="On Target", fontsize=16, fontweight="bold", color=Constants.COLORS["white"], ha="center"
        )
        ax3.text(x=0.3, y=6.6, s=f"{shots_on_target}", fontsize=16, color=Constants.COLORS["cyan"], ha="center")

        ax3.text(
            x=0.3, y=5.8, s="Off Target", fontsize=16, fontweight="bold", color=Constants.COLORS["white"], ha="center"
        )
        ax3.text(x=0.3, y=5.4, s=f"{shots_off_target}", fontsize=16, color=Constants.COLORS["cyan"], ha="center")

        ax3.text(
            x=0.3, y=4.6, s="Blocked", fontsize=16, fontweight="bold", color=Constants.COLORS["white"], ha="center"
        )
        ...
        ax3.text(
            x=0.3, y=2.2, s="xG/Shot", fontsize=16, fontweight="bold", color=Constants.COLORS["white"], ha="center"
        )
        ...
        ax4.scatter(
            x=0.45, y=0.3, s=size, color=self.cmap(0.2), edgecolor=Constants.COLORS["green"], linewidth=2.5, alpha=1
        )
        ax4.text(x=0.3, y=0.27, s=f"Goal", fontsize=15, color=Constants.COLORS["white"], ha="center")
        ax4.scatter(
            x=0.55, y=0.3, s=size, color=self.cmap(0.2), edgecolor=Constants.COLORS["white"], linewidth=2.5, alpha=1
        )
        ax4.text(x=0.7, y=0.27, s=f"On Target", fontsize=15, color=Constants.COLORS["white"], ha="center")
        ax4.scatter(
            x=0.55, y=0.1, s=size, color=self.cmap(0.2), edgecolor=Constants.COLORS["sb_grey"], linewidth=0.5, alpha=1
        )
